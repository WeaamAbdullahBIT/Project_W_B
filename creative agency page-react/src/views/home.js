    ...
    <div className="home-container">
          ...
          <div className="home-max-width max-content-container">
            <div className="home-heading-container">
              <div className="home-text-container">
                <span className="home-text">our services</span>
        ...
        <div className="section-container">
          <div className="home-max-width1 max-content-container">
            <div className="home-text-container1">
              <span className="home-text05">our work</span>
            ...
            <div className="home-tab-selector-header">
              <span className="home-text12 tab-selector-btn">Advertising</span>
              <span className="home-text13 tab-selector-btn">Social Media</span>
              <span className="home-text14 tab-selector-btn">Branding</span>
              <span className="home-text15 tab-selector-btn">UI / UX</span>
              <span className="home-text16 tab-selector-btn">Packaging</span>
        ...
        <div className="home-hero section-container">
          <div className="home-max-width2 max-content-container">
            <div className="home-heading-container1">
              <h1 className="home-text18 Heading1">
      ...
      <div className="section-container">
        ...
        <footer className="home-max-width8 max-content-container">
          <img alt="image" src="/logo1-200h.png" className="home-image7" />
